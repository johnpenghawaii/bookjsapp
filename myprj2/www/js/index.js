...
var app = {
    ...
    receivedEvent: function(id) {
		...
		var showElement = document.querySelector('#map1');
		showElement.setAttribute('style', 'display:block;');
        var watchID = navigator.geolocation.watchPosition(this.onSuccess, this.onError,  { timeout: 5000, enableHighAccuracy: true });
